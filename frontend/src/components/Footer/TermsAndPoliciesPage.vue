...
<template>
  <div class="text-container">
    ...
    <p>
      ...
      guidelines or rules applicable to such services. Any participation in this
      service will constitute acceptance of this agreement. If you do not agree
    ...
    <p>
      ...
      in a way that violates the rights of others. The following activities are
      strictly prohibited:
    </p>
    <ul>
      ...
      <li>Adult content or services, including erotic chat and pornography.</li>
    ...
    <p>
      ...
      Center for Missing and Exploited Children in the case of CSAM. Any illegal
      activities will be reported to the appropriate authorities.
    </p>

    <h2>Content Moderation</h2>
    <p>
      You acknowledge that we have the right, but not the obligation, to monitor
      and edit or remove any content. We may also remove or refuse to distribute
      any content on the service, suspend or terminate users, and reclaim
    ...
    <p>
      ...
      risk. This service is provided on an "as is" and "as available" basis. We
    ...
    <p>
      ...
      resulting from the use or inability to use the service or for the cost of
    ...
    <p>
      ...
      most current version of these terms on our website. Your continued use of
  ...
  <div class="text-container">
    ...
    <p>When you use Ascendance.cloud, we collect the following information:</p>
    <ul>
    ...
    <p>We use the information that we collect in various ways, including to:</p>
    <ul>
    ...
    <p>
      ...
      site, or your dealings with this site, please
      <a href="/contact">contact us</a>.
    </p>
  </div>
